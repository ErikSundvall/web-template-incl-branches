 ...
 * @since 3.1.0
 */
class EndTimeTest : AbstractWebTemplateTest() {
    @Test
    ...
    fun testEndTime() {
        ...
        Assertions.assertThat(JSR310ConversionUtils.toOffsetDateTime(observation.data!!.origin!!).compareTo(dateTime)).isEqualTo(0)
        Assertions.assertThat(composition.context!!.endTime!!.value).isEqualTo("2016-01-01T12:30:30Z")
    }
}
