 ...
 * @since 3.1.0
 *
 * Instance of [LocatablePostProcessor] that post-processes [Entry].
 *
 * @constructor Creates a new instance of [EntryPostProcessor]
 */
internal open class EntryPostProcessor<T : Entry> : LocatablePostProcessor<T>() {
    companion object {
        private val INSTANCE: EntryPostProcessor<out Entry> = EntryPostProcessor()

        @JvmStatic
        fun getInstance(): EntryPostProcessor<out Entry> = INSTANCE
    }
    ...
    override fun getOrder(): Int = Integer.MAX_VALUE - 1
